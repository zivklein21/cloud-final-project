...
__export(index_exports, {
  ...
  download: () => import_chunk_IFAMTZQZ.download,
  engineEnvVarMap: () => import_chunk_PXQVM7NP.engineEnvVarMap,
  getBinaryEnvVarPath: () => import_chunk_PXQVM7NP.getBinaryEnvVarPath,
  getBinaryName: () => import_chunk_IFAMTZQZ.getBinaryName,
  getCacheDir: () => import_chunk_YJOPKU47.getCacheDir,
  getProxyAgent: () => import_chunk_VAPNG6TS.getProxyAgent,
  getVersion: () => import_chunk_IFAMTZQZ.getVersion,
  maybeCopyToTmp: () => import_chunk_IFAMTZQZ.maybeCopyToTmp,
  overwriteFile: () => import_chunk_YJOPKU47.overwriteFile,
  plusX: () => import_chunk_IFAMTZQZ.plusX,
  vercelPkgPathRegex: () => import_chunk_IFAMTZQZ.vercelPkgPathRegex
});
module.exports = __toCommonJS(index_exports);
var import_chunk_IFAMTZQZ = require("./chunk-IFAMTZQZ.js");
